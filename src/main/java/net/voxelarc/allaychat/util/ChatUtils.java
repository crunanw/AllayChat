package net.voxelarc.allaychat.util;
...
public class ChatUtils {
    ...
    public final static MiniMessage MINI_MESSAGE = MiniMessage.builder()
            ...
            .preProcessor(s -> s.replace("<prefix>",
                    AllayChatPlugin.getInstance().getMessagesConfig().getString("messages.prefix", "")))
    ...
    public static Component format(String string, TagResolver... placeholders) {
        //fromLegacy(colorLegacyString(string))
